...
const LinkForm = () => {
    ...
    const handleTextSave = async () => {
        if (!text || !user?.displayName || !user?.email) { // textContent -> text
    ...
    return (
        <div>
            ...
            <div className="link-form p-4 max-w-lg mx-auto">
                ...
                <input type="file" onChange={handleFileChange} accept=".doc, .docx, .pdf, .jpg, .jpeg, .png" disabled={loading} className="mt-2 border p-2 rounded w-full" />
                <button onClick={handleFileUpload} disabled={loading || !file} className="mt-2 bg-blue-500 text-white py-2 px-4 rounded w-full">
                ...
                ></textarea>
                <button onClick={handleTextSave} className="mt-2 bg-green-500 text-white py-2 px-4 rounded w-full">
                    Save Text
                </button>
                {textLink && (
                    <div className="mt-4">
